...
[`@aws-sdk/client-docdb-elastic`](https://www.npmjs.com/package/@aws-sdk/client-docdb-elastic/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb-elastic@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-utiKez7TOBenTg+xE+KJa3NNDCTgeV74m6xc71pFKiEWtfkx12PZSSHmclaF4MLF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-docdb-elastic": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb-elastic@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb-elastic@3.312.0/index.min.mjs": "sha384-utiKez7TOBenTg+xE+KJa3NNDCTgeV74m6xc71pFKiEWtfkx12PZSSHmclaF4MLF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-docdb-elastic/blob/refs/tags/3.312.0/LICENSE
```
