...
[`@aws-sdk/client-docdb-elastic`](https://www.npmjs.com/package/@aws-sdk/client-docdb-elastic/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb-elastic@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cejVDf92su1EKmzYaQA6UpQhvPA6d62mcxqzFlUktBx5XJmA4nD6zeWmEXvl/fks
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-docdb-elastic": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb-elastic@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb-elastic@3.934.0/index.min.mjs": "sha384-cejVDf92su1EKmzYaQA6UpQhvPA6d62mcxqzFlUktBx5XJmA4nD6zeWmEXvl/fks"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-docdb-elastic/blob/refs/tags/3.934.0/LICENSE
```
