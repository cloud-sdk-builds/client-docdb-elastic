...
[`@aws-sdk/client-docdb-elastic`](https://www.npmjs.com/package/@aws-sdk/client-docdb-elastic/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb-elastic@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EkvXyHNJ3UdHcNfVSZwGCK8guI73v1R3pE8BdfyxD9WYAFK2IF3HIrxkFZSti8Hz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-docdb-elastic": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb-elastic@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-docdb-elastic@3.533.0/index.min.mjs": "sha384-EkvXyHNJ3UdHcNfVSZwGCK8guI73v1R3pE8BdfyxD9WYAFK2IF3HIrxkFZSti8Hz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-docdb-elastic/blob/refs/tags/3.533.0/LICENSE
```
